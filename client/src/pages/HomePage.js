...
const HomePage = () => {
  ...
  return (
    <Layout title={"All Products - Best offers"}>
      {/* banner image */}
      <div className="full-width-banner" style={{marginTop:"60px"}}>
        <img
      ...
      {/* banner image */}
      <div className="container-fluid row mt-3 home-page" style={{background: "linear-gradient(90deg, #CC95C0, #DBD4B4, #7AA1D2)",}}>
